                            ...
                            <form id="formAccountSettings" method="POST" action="/edit-product/{{$product->id}}"
                                ...
                                <div class="row">
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        <img src={{ asset('images/')."/".$product->image }} class="d-block rounded"
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input class="form-control" type="text" id="firstName" name="price"
                                            value="{{ $product->price }}" autofocus />
                                    </div>
                                    <div class="mb-3 col-md-12">
                                        <label for="firstName" class="form-label">QTY</label>
                                        <input class="form-control" type="text" id="firstName" name="qty"
                                            value="{{ $product->qty }}" autofocus />
                                    </div>
                                    <div class="mb-3 col-md-12">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <select id="category" class="form-control selectpicker" name="arr_category[]"
                                            multiple>
